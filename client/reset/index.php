...
//
// Το πρόγραμμα δέχεται ως παράμετρο ένα κωδικό με όνομα παραμέτρου "code"
...
// πρόγραμμα επανεκκινει τον server σκηνικού.
...
// Στο σημείο αυτό ο server σκηνικού έχει επανεκκινήσει σωστά, οπότε
// καταργούμε τυχόν ενεργό session και φορτώνουμε τη σελίδα της βίδας.
